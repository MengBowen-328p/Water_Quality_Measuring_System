...
static void Home_Page_btn_1_event_handler (lv_event_t *e)
{
	...
	{
		ui_load_scr_animation(&guider_ui, &guider_ui.Ca_Measure_Page, guider_ui.Ca_Measure_Page_del, &guider_ui.Home_Page_del, setup_scr_Ca_Measure_Page, LV_SCR_LOAD_ANIM_NONE, 200, 200, true, true);
		break;
	}
	default:
		break;
...
static void Ca_Measure_Page_btn_1_event_handler (lv_event_t *e)
{
	...
	case LV_EVENT_CLICKED:
	{
		ui_load_scr_animation(&guider_ui, &guider_ui.Home_Page, guider_ui.Home_Page_del, &guider_ui.Ca_Measure_Page_del, setup_scr_Home_Page, LV_SCR_LOAD_ANIM_NONE, 200, 200, false, true);
		break;
	}
	default:
		break;
