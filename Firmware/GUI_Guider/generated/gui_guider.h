...
typedef struct
{
	...
	lv_obj_t *Home_Page;
	bool Home_Page_del;
	lv_obj_t *Home_Page_btn_1;
	lv_obj_t *Home_Page_btn_1_label;
	lv_obj_t *Home_Page_btn_2;
	lv_obj_t *Home_Page_btn_2_label;
	lv_obj_t *Home_Page_btn_3;
	lv_obj_t *Home_Page_btn_3_label;
	lv_obj_t *Home_Page_btn_4;
	lv_obj_t *Home_Page_btn_4_label;
	lv_obj_t *Home_Page_btn_5;
	lv_obj_t *Home_Page_btn_5_label;
	lv_obj_t *Home_Page_label_1;
	lv_obj_t *Ca_Page;
	bool Ca_Page_del;
	lv_obj_t *Ca_Page_btn_1;
	lv_obj_t *Ca_Page_btn_1_label;
	lv_obj_t *Ca_Page_btn_2;
	lv_obj_t *Ca_Page_btn_2_label;
	lv_obj_t *Ca_Page_btn_3;
	lv_obj_t *Ca_Page_btn_3_label;
	lv_obj_t *Ca_History_Page;
	bool Ca_History_Page_del;
	lv_obj_t *Ca_History_Page_label_1;
	lv_obj_t *Ca_History_Page_btn_1;
	lv_obj_t *Ca_History_Page_btn_1_label;
	lv_obj_t *Ca_Measure_Page;
	bool Ca_Measure_Page_del;
	lv_obj_t *Ca_Measure_Page_label_1;
	lv_obj_t *Ca_Measure_Page_btn_1;
	lv_obj_t *Ca_Measure_Page_btn_1_label;
}lv_ui;
