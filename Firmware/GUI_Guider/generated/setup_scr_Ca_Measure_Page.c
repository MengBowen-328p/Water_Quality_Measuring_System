...
void setup_scr_Ca_Measure_Page(lv_ui *ui)
{
	...
	//Write codes Ca_Measure_Page_label_1
	ui->Ca_Measure_Page_label_1 = lv_label_create(ui->Ca_Measure_Page);
	lv_label_set_text(ui->Ca_Measure_Page_label_1, "Measurement");
	lv_label_set_long_mode(ui->Ca_Measure_Page_label_1, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->Ca_Measure_Page_label_1, 76, 102);
	lv_obj_set_size(ui->Ca_Measure_Page_label_1, 169, 36);

	//Write style for Ca_Measure_Page_label_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
	lv_obj_set_style_border_width(ui->Ca_Measure_Page_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_radius(ui->Ca_Measure_Page_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_color(ui->Ca_Measure_Page_label_1, lv_color_hex(0x000000), LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_font(ui->Ca_Measure_Page_label_1, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_opa(ui->Ca_Measure_Page_label_1, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_letter_space(ui->Ca_Measure_Page_label_1, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_line_space(ui->Ca_Measure_Page_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_text_align(ui->Ca_Measure_Page_label_1, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_bg_opa(ui->Ca_Measure_Page_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_top(ui->Ca_Measure_Page_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_right(ui->Ca_Measure_Page_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_bottom(ui->Ca_Measure_Page_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_pad_left(ui->Ca_Measure_Page_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	lv_obj_set_style_shadow_width(ui->Ca_Measure_Page_label_1, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
	...
	lv_obj_set_size(ui->Ca_Measure_Page_btn_1, 73, 38);
